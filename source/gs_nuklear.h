...
NK_API void                 gs_nk_render(gs_nk_ctx_t* gs, gs_command_buffer_t* cb, enum nk_anti_aliasing AA, gs_graphics_clear_desc_t* clear);
...
NK_API void
gs_nk_render(gs_nk_ctx_t* gs, gs_command_buffer_t* cb, enum nk_anti_aliasing AA, gs_graphics_clear_desc_t* clear)
{
